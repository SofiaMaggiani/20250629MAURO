%Tesis de Mauro Dobrusky
%Editado por Sofia Maggiani
...
\usepackage[allcolors=black, colorlinks, unicode]{hyperref}
...
\input{./files/gbTeXmeta-20250629MAURO.tex}
	...
	\input{./files/gbTeXmeta-20250629MAURO.tex}
		...
		\else
			\ifHTMLEPUB
			\usepackage[allcolors=black,colorlinks,hyperindex=true,unicode]{hyperref}
			\fi
		\fi
	\fi
\fi

% Definir el color de fondo: gris con  30% de cyan
\definecolor{chaptercircle}{cmyk}{0.3,0,0,0}
...
\epigraph {\enquote{--¿Y si se rompe la ilusión? --dije con un hilo de voz.
	...
	\emph{Esse est percipi} (Ser es ser percibido) \footnote{\fullcite{@6962-BORGESBIOY1967}}}
...
Baldoni y Gómez Rodríguez (2018) dan cuenta del fenómeno mostrando el proceso de incorporación de la producción de libros de periodistas en el mercado editorial, inicialmente desde las pequeñas editoriales. Luego, a partir de la consolidación de este género, las grandes casas editoriales encontraron, como muestra \parencite{@6972-SAFERSTEIN2016}, un nicho de mercado propicio para la producción de \emph{best-sellers}.
...
Es este un magnífico discurso legitimante de la actividad de los medios. Pero no era solo Clarín o sus periodistas los que se sentían agredidos o en medio de una guerra. Hacia el fin del período seleccionado, \textcite[8, 11]{@6997-NOVARO2015} sostienen, en \emph{Grandes y pequeñas mentiras que nos contaron}:
...
\textcite[4]{@7000-BARONE2011}, uno de los expatriados, cita en su libro, \emph{K Letra bárbara. Periodismo sucio y público sublevado}, una leyenda que circula en el medio y que refleja de alguna manera a este tipo de periodista que, en general, suele destacarse en los medios dominantes:
...
\begin{quote}
	Nadie podría acusar a Verbitsky de opositor. Verdadero titán del periodismo independiente durante los 90 y entendido en guerrillas setentistas, el \enquote{Perro} pasó a ser un adalid intelectual del autodefinido \enquote{kirchnerismo racional} \parencite[10]{@7068-ZUNINO2011}.
\end{quote}
...
\begin{quote}
	En demasiadas ocasiones los medios se mostraron bastante cómodos ocupando un lugar de oposición que no se corresponde con su esencia: la lealtad al lector, al oyente, al televidente. También de este lado del mostrador queda mucho por aprender, revisar y corregir. \textbf{No se trata de salvar a tal o cual empresa. Hay que salvar al periodismo}. El bicentenario está a la vuelta de la esquina. Sonará estúpidamente obvio, pero el pueblo sigue queriendo saber de qué se trata, mientras los gobernantes insisten en vendérsela cambiada \parencite[280]{@7068-ZUNINO2011}.\footnote{El énfasis es propio.}
\end{quote}
...
La periodista Silvia Naishtat, de \emph{Clarín}, argumentó en su renuncia: \enquote{El comunicado que yo había firmado no fue el que finalmente salió. El que yo firmé tenía un párrafo en donde se le pedía a \emph{Página 12} que reflexionara sobre lo ocurrido, pero finalmente desapareció} \parencite[49]{@7068-ZUNINO2011}. Parece un débil argumento para tamaña decisión. Algo mucho más importante estaba en gestación.

Otro periodista, Jorge Lanata, presenta en su nota de renuncia la siguiente frase: \enquote{Condeno por igual a la censura pública como a la privada, y lamento que esta asociación se haya transformado en una especie de politburó elefantiásico, lento y acomodaticio} \parencite[49]{@7068-ZUNINO2011}.
...
\begin{quote}
	Jorge, cuando me pediste que levantara una nota sobre (Fernando de) Santibañes porque acababas de pedirle ayuda para conseguir un crédito, ¿fue censura o relación entre editor y columnista? \parencite[50]{@7068-ZUNINO2011}.
\end{quote}
