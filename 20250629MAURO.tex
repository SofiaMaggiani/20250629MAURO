% referencias
\addbibresource{./files/gbTeXbib-20250629MAURO.bib}

% glosarios
\input{./files/gbTeXglo-20250629MAURO.tex}

\ifPDF
% separata de capítulos solo en pdf de pantalla

\input{./files/gbTeXseparata-20250629MAURO.tex}
...
\usepackage{hyperxmp}
\input{./files/gbTeXmeta-20250629MAURO.tex}
\else
\ifBNPDF
\usepackage[width=18truecm,height=25.5truecm,cam,center]{crop}
\newcommand*\infofont[1]{\sf{\footnotesize #1 (sofia.maggiani@gmail.com)}}
\crop[font=infofont]
...
\epigraph {\enquote{--¿Y si se rompe la ilusión? --dije con un hilo de voz.
	...
	\emph{Esse est percipi} (Ser es ser percibido) \parencite{@6962-BORGESBIOY1967}}
...
%%––––– Tabla –––––––––––––––––––––––––––––––––––––––––––––
%\begin{longtable}{@{}
%		>{\raggedright\arraybackslash}p{0.160\linewidth}   % Medio
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2010
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2011
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2012
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2013
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2014
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2015
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2016
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2017
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2018
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}    % 2019
%		>{\raggedleft\arraybackslash}p{0.105\linewidth}@{}}% Dif.
%	\toprule
...
%	\shortstack{\textbf{Dif.}\\\textbf{2010/2019}} \\
%	\midrule
%	\endhead
...
%\begin{longtable}{@{}
%		>{\raggedright\arraybackslash}p{0.151\linewidth}  % Diario
%		>{\raggedright\arraybackslash}p{0.110\linewidth}  % Localidad
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2010
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2011
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2012
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2013
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2014
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2015
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2016
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2017
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2018
%		>{\raggedleft\arraybackslash}p{0.073\linewidth}   % 2019
%		>{\raggedleft\arraybackslash}p{0.075\linewidth}@{}}% Dif.
%	\toprule
%	\textbf{Diario} & \textbf{Localidad} &
%	\textbf{2010} & \textbf{2011} & \textbf{2012} & \textbf{2013} &
%	\textbf{2014} & \textbf{2015} & \textbf{2016} & \textbf{2017} &
%	\textbf{2018} & \textbf{2019} &
%	\shortstack{\textbf{Dif.}\\\textbf{2010/19}} \\
%	\midrule
%	\endhead
%	Clarín              & AMBA        & 664 & 591 & 599 & 570 & 513 & 508 & 487 & 446 & 388 & 396 & \textbf{–40} \\
%	La Nación           & AMBA        & 280 & 332 & 360 & 331 & 323 & 320 & 302 & 288 & 209 & 201 & \textbf{–28} \\
%	Diario Popular      & AMBA        & 147 & 131 & 135 & 131 & 120 & 118 & 106 &  95 &  85 &  73 & \textbf{–50} \\
%	La Voz del Interior & Córdoba     &  99 &  90 &  90 &  90 &  84 &  81 &  73 &  66 &  59 &  53 & \textbf{–46} \\
%	Los Andes           & Mendoza     &  83 &  78 &  77 &  73 &  68 &  65 &  57 &  52 &  49 &  43 & \textbf{–48} \\
%	La Capital          & Rosario     &  82 &  80 &  76 &  67 &  62 &  56 &  47 &  41 &  36 &  30 & \textbf{–63} \\
%	La Gaceta           & Tucumán     &  61 &  62 &  60 &  56 &  56 &  55 &  49 &  45 &  40 &  34 & \textbf{–44} \\
%	Río Negro           & Gral. Roca  &  45 &  44 &  42 &  36 &  35 &  35 &  32 &  28 &  26 &  21 & \textbf{–53} \\
%	El Día              & La Plata    &  40 &  41 &  39 &  35 &  35 &  33 &  31 &  26 &  23 &  19 & \textbf{–52} \\
%	Diario Uno          & Entre Ríos  &  36 &  38 &  22 &  34 &  30 &  28 &  26 &  26 &  25 &  11 & \textbf{–69} \\
%	\bottomrule
%\end{longtable}

Con respecto a la circulación de diarios pagos, los títulos auditados registraron en general bajas en su circulación. En los últimos 10 años, \emph{Clarín} redujo sus ventas un 33\%, \emph{Diario Popular} el 48\% y \emph{La Nación} el 37\% (ver Cuadro~\ref{table:diarios}).
...
La prensa ha sido durante el siglo XX uno de los fenómenos sobre los que las ciencias sociales han reflexionado de manera intensa, considerando su importancia en los sistemas democráticos y consecuentemente por su capacidad de influencia en la opinión pública y las formas que ésta adopta. Entre los temas centrales abordados por los investigadores se halla la relación entre los medios y las audiencias, habiendo quedado, en general, relegada la atención sobre el fenómeno de los periodistas, los que hacen las noticias y/o deciden sobre ellas (\emph{gatekeepers} y \emph{newsmakers}). \textcite[203]{@6974-WOLF2004} observa lo tardío e importante de dichos estudios frente a las investigaciones centradas en la relación entre \emph{mass media} y opinión pública
...
Recientemente, algunos autores \parencite{@6975-RUIZ2014, @6976-AMADO2016} han sostenido que, en general, han sido escasas las investigaciones sobre la sociología de los periodistas en Argentina, al punto de considerar que los periodistas como objeto de estudio sólo fueron incluidos en ensayos y descripciones de circunstancias. Si bien esta afirmación no refleja cabalmente la situación, es cierto que algunos de los trabajos realizados bajo el auspicio de instituciones académicas, fueron abordados desde una perspectiva más de divulgación que académica, muchas veces por estar a cargo, no de investigadores científicos sino de periodistas devenidos académicos.

\textcite{@6976-AMADO2016} cita como antecedentes tres trabajos consecutivos que se propusieron un abordaje sociológico de los profesionales del periodismo: el de \textcite{@6977-FRAGA1997}, el de \textcite{@6978-BELIZ1998} y el de \textcite{@6979-MAJUL1999}. Los tres trabajos tienen un denominador común: sus autores son o actuaron en el campo periodístico y además fueron o son consultores de empresas. Fraga, Béliz y Zuleta Puceiro son abogados y consultores de opinión pública; Majul es periodista, pero además empresario de medios.

\textcite{@6977-FRAGA1997} articula la opinión que los periodistas tienen de su profesión, con el de la opinión pública y la de líderes de opinión, sobre su actividad. El trabajo, basado en encuestas a periodistas, ciudadanos adultos en general, y altos funcionarios gubernamentales, jueces, diputados y senadores, indagó la opinión sobre la política, la justicia y la prensa entre los tres grupos en los que se segmentó la investigación., dando por resultado, en ese momento, una alta imagen de la prensa por sobre los demás factores de poder. Podemos afirmar que Fraga parte desde un marco teórico de \emph{agenda setting}; identifica tres grandes agendas: la política, la de los medios y la de la opinión pública y estudia la relación entre ellas, desde la perspectiva de los actores.

Por su parte, \textcite{@6978-BELIZ1998} analizan la cultura profesional del periodismo argentino, a través de una encuesta a periodistas, centrando la atención en la percepción que los periodistas tienen sobre la libertad para expresarse, pero avanzando sobre algunas consideraciones de la cultura del campo. Es de destacar que, entre las principales amenazas a la libertad de expresión, la categoría que concentró la mayor cantidad de respuestas fue \enquote{el proceso de concentración de medios de comunicación}, seguido de la \enquote{dependencia respecto a la publicidad de empresas privadas}. Ambas respuestas fueron señaladas por más del 80\% de los encuestados.
...
Unos meses más tarde, \textcite{@6981-ARRUETA2013} aborda también este conflicto, poniéndole nombre a las formas de periodismo enfrentadas \rdm{\emph{periodismo corporativo} y \emph{periodismo militante}} y rastrea su historia conceptual en el país. Más adelante, continúa con esta búsqueda y aborda los aspectos identitarios del campo periodístico en el proceso de relación con las empresas de medios.
...
Retrocediendo en la historia, en la primera década del siglo XX, \textcite{@6988-WEBER1992} propuso un programa de investigación sociológica de la prensa, a la luz de la creciente importancia y prestigio de la profesión. El autor reveló, así, su original interés por este grupo profesional, que comenzaba a exhibirse públicamente como cohesionado.
...
En \emph{Algunas propiedades de los campos}, \textcite[112]{@6961-BOURDIEU2008} sostiene:
...
Sostiene \textcite[III]{@6990-VERON1987} en \emph{Construir el acontecimiento} que:
...
Según \textcite[IV]{@6990-VERON1987}
...
\textcite[10]{@6991-MERCADO2012}, en un trabajo reciente, recuerda:
...
Según \textcite[115]{@6961-BOURDIEU2008},
...
%––––– Tabla ––––––––––––––––––––––––––––––––––––––––––––
\begin{longtable}{@{}
		>{\raggedright\arraybackslash}p{0.174\linewidth}  % Categoría
		>{\raggedright\arraybackslash}p{0.133\linewidth}  % Siglo XVI
		>{\raggedright\arraybackslash}p{0.138\linewidth}  % Siglo XVII
		>{\raggedright\arraybackslash}p{0.156\linewidth}  % Siglo XVIII
		>{\raggedright\arraybackslash}p{0.138\linewidth}  % Siglo XIX
		>{\raggedright\arraybackslash}p{0.131\linewidth}  % Siglo XX
		>{\raggedright\arraybackslash}p{0.131\linewidth}@{}}% Siglo XXI
	\toprule
	& \textbf{Siglo XVI} & \textbf{Siglo XVII} & \textbf{Siglo XVIII} &
	\textbf{Siglo XIX} & \textbf{Siglo XX} & \textbf{Siglo XXI} \\
	\midrule
	\endhead
	Crematística & & & & & & \\
	De opinión   & & & & & & \\
...
\begin{quote}
	Creo que lo que 6 7 8 incorporó antes que nadie (y no digo que sea un rasgo positivo), fue el choque frontal con otros periodistas. Antes de 6 7 8, nadie se había metido con un periodista desde un programa de televisión. No existía la denuncia contra el medio de comunicación \parencite[72]{@6995-OLIVAN2009}.
\end{quote}
...
\textcite[7]{@6996-SIVAK2015}, en \emph{Clarín, la era Magnetto} afirma, en el prólogo, que el libro

\begin{quote}
(\ldots) empieza y termina con dos guerras muy distintas. Abre con la de Malvinas de 1982, vista desde las páginas del diario de la señora de Noble; \emph{cierra con la imaginaria y prolongada que ha librado el Grupo con los Kirchner desde el conflicto agropecuario de 2008.}\footnote{El énfasis es propio.}
\end{quote}
...
Es este un magnífico discurso legitimante de la actividad de los medios. Pero no era solo Clarín o sus periodistas los que se sentían agredidos o en medio de una guerra. Hacia el fin del período seleccionado, \textcite[8, 11]{@6997v-NOVARO2015} sostienen, en \emph{Grandes y pequeñas mentiras que nos contaron}:
...
%––––– Tabla de títulos y autores ––––––––––––––––––––––––––
\begin{longtable}{@{}
		>{\raggedright\arraybackslash}p{0.365\linewidth}   % Título
		>{\raggedright\arraybackslash}p{0.254\linewidth}   % Editorial
		>{\centering  \arraybackslash}p{0.079\linewidth}   % Nº
		>{\raggedright\arraybackslash}p{0.302\linewidth}@{}}% Autor
	\toprule
	...
	%--------------------------------------------------------------------
	\textbf{2009}                    &&& \\[.3em]
	Diario de guerra. \emph{Clarín, el gran engaño argentino} (2009) & Gárgola & 1 & Claudio Díaz \\[.6em]

	\textbf{2010}                    &&& \\[.3em]
	678. La creación de otra realidad (2010) & \href{http://www.lecturalia.com/editoriales/79/paidos}{Paidós} / Planeta & 2 & María Julia Oliván y Pablo Alabarces \\
	Silencio por sangre (2010)       & Miradas al Sur   & 3 & Daniel Cecchini y Jorge Mancinelli \\[.6em]

	\textbf{2011}                    &&& \\[.3em]
	Pecado original (2011)           & \href{http://www.tematika.com/...}{Planeta} & 4 & \href{http://www.tematika.com/...}{Graciela Mochkofsky} \\
	Perón y los medios de comunicación (2011) & Sudamericana / \href{https://es.wikipedia.org/wiki/Penguin_Random_House_Grupo_Editorial}{PRH} & 5 & Pablo Sirvén \\
	K Letra bárbara (2011)           & Sudamericana / PRH & 6 & Orlando Barone \\
	El kirchnerismo póstumo (2011)   & Ediciones B      & 7 & Jorge Asís \\
	Patria o medios (2011)           & Sudamericana / PRH & 8 & Edi Zunino \\
	\href{http://www.casassaylorenzo.com/...}{Periodismo de infantería} (2011) &
	\href{http://www.casassaylorenzo.com/resultados.aspx?...}{Clarinete} & 9 & Virginia Márquez y Aníbal \href{http://www.libreriapaidos.com/...}{Ces} \\[.6em]

	\textbf{2012}                    &&& \\[.3em]
	Lanata (2012)                    & Margen Izquierdo & 10 & Luis \href{http://www.cuspide.com/...}{Majul} \\[.6em]

	\textbf{2013}                    &&& \\[.3em]
	\href{https://www.boutiquedellibro.com.ar/...}{Aquel periodismo}. Medios y periodistas en la Argentina 1965–2012 (2013) &
	\href{http://www.libreriapaidos.com/...}{Edhasa} & 11 & \href{http://www.edhasa.com.ar/...}{Daniel Muchnik} \\
	Víctor Hugo, una historia de coherencia y convicción (2013) & Ediciones al Arco & 12 & Julián Capasso \\
	El inventor del peronismo (2013) & Planeta          & 13 & Silvia Diana Mercado \\
	Máquinas de captura. Los medios concentrados en tiempos del kirchnerismo (2013) & Colihue & 14 & Daniel Rosso \\
	\href{http://www.cuspide.com/9789504932871/...}{Clarín, el gran diario argentino: una historia} (2013) & Planeta & 15 & Martín Sivak \\
	Años de rabia (2013)             & \href{http://www.edicionesb-argentina.com/}{Ediciones B} & 16 & Eduardo Blaustein \\
	Converso (2013)                  & Margen Izquierdo & 17 & Pablo Sirvén \\
	El pequeño Timerman (2013)       & Ediciones B      & 18 & Gabriel \href{http://www.edicionesb-argentina.com/...}{Levinas} \\[.6em]

	\textbf{2014}                    &&& \\[.3em]
	Nuevos desafíos del periodismo (2014) &
	Ariel / Paidós – Planeta – ADEPA & 19 &
	Daniel Dessein y Gastón Roitberg (comp.) \\
	Periodistas en el barro… (2014)  & Sudamericana / PRH & 20 & \href{http://buscapdf.es/...}{Edi Zunino} \\
	Tiempos turbulentos (2014)       & Ariel / Paidós – Planeta – ADEPA & 21 &
	\href{http://www.planetadelibros.com.ar/...}{Carlos Jornet} y \href{http://www.planetadelibros.com.ar/...}{Daniel Dessein} \\
	Télam, el hecho maldito del periodismo argentino (2014) & Ediciones TXT & 22 &
	\href{http://www.libreriahernandez.com/...}{Ariel Bargach} y
	\href{http://www.libreriahernandez.com/...}{Mariano Suárez} \\
	(In)justicia mediática (2014)     & Sudamericana / PRH & 23 & Darío \href{http://www.cuspide.com/...}{Villarruel} \\
	Audiencia con el diablo (2014)    & Aguilar          & 24 & Víctor Hugo \href{http://www.cuspide.com/...}{Morales} \\
	Las locuras del Rey Jorge (2014)  & Ediciones B      & 25 & Eduardo \href{http://www.edicionesb-argentina.com/...}{Blaustein} \\
	Guerras mediáticas (2014)         & Sudamericana / PRH & 26 & Fernando Ruiz \\[.6em]

	\textbf{2015}                    &&& \\[.3em]
	\href{https://www.boutiquedellibro.com.ar/...}{Quiénes fuimos en la era K} (2015) & Planeta & 27 & Jorge \href{http://www.cuspide.com/...}{Fontevecchia} \\
	El Perro (2015)                  & Ediciones B      & 28 & Hernán \href{http://www.edicionesb-argentina.com/...}{López Echague} \\
	\bottomrule
\end{longtable}
