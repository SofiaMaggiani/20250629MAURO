...
\usepackage{caption}  % opcional: mejora el formato del caption
\usepackage{ragged2e}
\usepackage{pdflscape}
\sisetup{table-format=4.0} % configuración general para siunitx
...
\input{./files/gbTeXseparata-20250425MAURO.tex}
...
\usepackage{hyperxmp}
\input{./files/gbTeXmeta-20250425MAURO.tex}
\else
\ifBNPDF
...
\begin{document}
	...
	\chapter[\hspace{1.5pc}Agradecimientos]{Agradecimientos}

	A los docentes de la Maestría en Industrias Culturales de la Universidad Nacional de Quilmes y en particular a Nadia Koziner, por haberme devuelto la alegría de estudiar.
	...
	En la Argentina, la intervención de periodistas como autores de libros que discuten sobre el campo periodístico y su legitimidad cuenta con una larga tradición desde los inicios mismos de la Nación\footnote{Entre otros estudios sobre debates en torno a la construcción y legitimación del campo periodístico desde los orígenes de la prensa argentina, Cfr. Rivera (1968, \citeyear{@6965-RIVERA1990}, \citeyear{@6966-RIVERA1998}), Molina (2012), Alonso (\citeyear{@6960-ALONSO1997}, 2004), Moyano (\citeyear{@6968-MOYANO1996}, \citeyear{@6969-MOYANO2008}, \citeyear{@6970-MOYANO2013}), Ojeda y Moyano (2015, 2019), Ojeda (2010), De Marco (2006), Díaz, (2012), Auza (1978).}. Sin embargo, el período que transcurre entre los años 2009 y 2015 fue especialmente pródigo en la cantidad y diversidad de material que se produjo sobre el tema, con especial énfasis en la crítica a colegas y/o a medios de comunicación.

	Desde la reinstalación del sistema democrático, en 1984, es posible identificar el desarrollo y la consolidación de los libros de periodistas como uno de los géneros predominantes del ámbito editorial \parencite{@6961-DEDIEGO2012}. Por otra parte, este fenómeno constituye una forma de intervención pública y de jerarquización profesional en el ámbito periodístico (Pereyra, 2013; Vommaro y Baldoni, 2012).

	Baldoni y Gómez Rodríguez (2018) dan cuenta del fenómeno mostrando el proceso de incorporación de la producción de libros de periodistas en el mercado editorial, inicialmente desde las pequeñas editoriales. Luego, a partir de la consolidación de este género, las grandes casas editoriales encontraron, como muestra \parencite{@6962-SAFERSTEIN2016}, un nicho de mercado propicio para la producción de \emph{best-sellers}.
	...
	\begin{table}[!ht]
		...
		\begin{tabular}{l | S[table-format=2.1] | S[table-format=2.1]| S[table-format=2.0]| S[table-format=2.1]| S[table-format=2.1]| S[table-format=2.1]| S[table-format=2.0]| S[table-format=2.0]| S[table-format=2.0] }
			...
			\midrule
			Televisión abierta y cable & 47.7 & 44.4 & 45.0 & 46.9 & 39.5 & 38.6 & 39 & 41 & 41 \\
			\midrule
			Radios en AMBA e interior & 3.2 & 3.2 & 3.7 & 4.0 & 4.6 & 5.0 & 8 & 8 & 8 \\
			\midrule
			Diarios en AMBA e interior & 34.0 & 35.0 & 34.0 & 31.0 & 25.0 & 22.0 & 21 & 16 & 15 \\
			\midrule
			Revistas & 4.7 & 4.8 & 4.6 & 4.2 & 3.1 & 3.0 & 3 & 2 & 2 \\
			\midrule
			Vía pública & 5.5 & 5.2 & 4.3 & 4.3 & 4.5 & 5.0 & 5 & 5 & 7 \\
			\midrule
			Cine & 1.3 & 1.2 & 1.3 & 1.3 & 1.2 & 1.0 & 1 & 1 & 1 \\
			\midrule
			Internet & 4.3 & 6.1 & 7.4 & 8.0 & 16.0 & 20.0 & 20 & 24 & 25 \\
			\bottomrule
		\end{tabular}
		\caption{Evolución de la distribución de la inversión publicitaria por medio entre 2010 y 2018 en la Argentina (\%)}
		\label{table:inve}
	\end{table}

	%\ul{Fuente}: Cámara Argentina de Agencias de Medios}

Mientras que en 2010 los diarios y revistas del AMBA recibían el 39\% de la inversión publicitaria y la TV el 48\%\footnote{Fuente: Asociación Argentina de Editores de Revistas.},durante la segunda década esa relación cambia drásticamente, como puede verse en el Cuadro~\ref{table:inve}. Durante el año 2018, el 41\% de la inversión publicitaria se dirige a la TV y apenas el 17\% a los medios gráficos, en una brecha que tiende a acrecentarse sobre la base de la estabilidad en los medios audiovisuales, el descenso de la gráfica y el vertiginoso crecimiento de la inversión en Internet.

En la actualidad, la venta de diarios en la Argentina ronda los 200 millones de ejemplares por año. La evolución de la venta neta total de diarios, en el año 2018, ha registrado un nuevo retroceso (-10\%)\footnote{Fuente: Elaboración propia basada en datos del IVC.}, el cual estuvo acompañado por una merma de los lectores de diarios (-7\%) en 2017 con respecto al año anterior.


%\begin{table}[!ht]
%	\sf\footnotesize\setlength\tabcolsep{4pt}
%	\centering
%	\begin{tabular}{l | S[table-format=4.0] | S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0]| S[table-format=4.0] | S[table-format=4.0] | c }
	%		\toprule
	%		\textbf{Diario} & \textbf{2010} & \textbf{2011} & \textbf{2012} & \textbf{2013} & \textbf{2014} & \textbf{2015} & \textbf{2016} & \textbf{2017} & \textbf{2018} & \textbf{2019} & \textbf{Dif. 2010/2019} \\
	%		\midrule
	...
	%		\bottomrule
	%	\end{tabular}
%	\caption{Circulación neta promedio de los principales diarios del AMBA (en miles)\footnote{Fuente: Elaboración propia según datos del IVC. Se consideró el promedio semanal de lunes a domingo durante el mes de mayo de cada año.}}
%	\label{table:diario1}
%\end{table}
...
\begin{table}[!ht]
	...
	\centering
	\begin{tabularx}{\textwidth}{l | *{10}{>{\centering\arraybackslash}X} | >{\centering\arraybackslash}X}
		\toprule
		\textbf{Diario} & \textbf{2010} & \textbf{2011} & \textbf{2012} & \textbf{2013} & \textbf{2014} & \textbf{2015} & \textbf{2016} & \textbf{2017} & \textbf{2018} & \textbf{2019} & \textbf{Dif. 10/19} \\
		\midrule
		Clarín & 301 & 288 & 271 & 279 & 239 & 238 & 207 & 183 & 206 & 213 & -33 \\
		\midrule
		La Nación & 150 & 160 & 162 & 168 & 164 & 156 & 130 & 122 & 117 & 100 & -37 \\
...
\begin{table}[!ht]
	...
	\begin{tabularx}{\textwidth}{
		...
		\toprule
		\textbf{Diario} & \textbf{Localidad} & \textbf{2010} & \textbf{2011} & \textbf{2012} & \textbf{2013} & \textbf{2014} & \textbf{2015} & \textbf{2016} & \textbf{2017} & \textbf{2018} & \textbf{2019} \\
		\midrule
		Clarín & AMBA & 664 & 591 & 599 & 570 & 513 & 508 & 487 & 446 & 388 & 396 \\
		\midrule
		La Nación & AMBA & 280 & 332 & 360 & 331 & 323 & 320 & 302 & 288 & 209 & 201 \\
		\midrule
		Diario Popular & AMBA & 147 & 131 & 135 & 131 & 120 & 118 & 106 & 95 & 85 & 73 \\
		\midrule
		La Voz del Int. & Córdoba & 99 & 90 & 90 & 90 & 84 & 81 & 73 & 66 & 59 & 53 \\
		\midrule
		Los Andes & Mendoza & 83 & 78 & 77 & 73 & 68 & 65 & 57 & 52 & 49 & 43 \\
		\midrule
		La Capital & Rosario & 82 & 80 & 76 & 67 & 62 & 56 & 47 & 41 & 36 & 30 \\
		\midrule
		La Gaceta & Tucumán & 61 & 62 & 60 & 56 & 56 & 55 & 49 & 45 & 40 & 34 \\
		\midrule
		Río Negro & Gral. Roca & 45 & 44 & 42 & 36 & 35 & 35 & 32 & 28 & 26 & 21 \\
		\midrule
		El Día & La Plata & 40 & 41 & 39 & 35 & 35 & 33 & 31 & 26 & 23 & 19 \\
		\midrule
		Diario Uno & Entre Ríos & 36 & 38 & 22 & 34 & 30 & 28 & 26 & 26 & 25 & 11 \\
		\bottomrule
	\end{tabularx}
	\caption{Ranking de circulación de diarios. Día domingo, promedio mes de mayo. Primeros 10 títulos (en miles), 2010--2019\footnote{Elaboración propia con datos del IVC.}}
	\label{table:diario2}
\end{table}

Con respecto a la circulación de diarios pagos, los títulos auditados registraron en general bajas en su circulación. En los últimos 10 años, \emph{Clarín} redujo sus ventas un 33\%, \emph{Diario Popular} el 48\% y \emph{La Nación} el 37\% (ver Cuadro~\ref{table:diario1}).
...
\begin{figure}[ht] % h = here (aquí), puede combinarse con t (top), b (bottom), p (página flotante)
	\centering
	\includegraphics[width=0.9\textwidth]{media/grafico2.png}
	\caption{Distribución de las ediciones por años y editoriales}
	\label{fig:graf2}
\end{figure}
...
Unos meses más tarde, Arrueta (2012) aborda también este conflicto, poniéndole nombre a las formas de periodismo enfrentadas \rdm{\emph{periodismo corporativo} y \emph{periodismo militante}} y rastrea su historia conceptual en el país. Más adelante, continúa con esta búsqueda y aborda los aspectos identitarios del campo periodístico en el proceso de relación con las empresas de medios.
...
Estos últimos trabajos muestran el interés por descubrir, en el conflicto, la constitución de identidades profesionales, que no parecen consolidarse de manera externa al campo periodístico.
...
En la Argentina, las producciones bibliográficas fueron el modo privilegiado que los integrantes del campo periodístico encontraron para dirimir sus posiciones y legitimar su reconocimiento.
...
\begin{figure}[ht] % h = here (aquí), puede combinarse con t (top), b (bottom), p (página flotante)
	\centering
	\includegraphics[width=0.9\textwidth]{media/diagrama.png}
	\caption{}
	\label{fig:diagra}
\end{figure}
...
Refiriéndose a los campos de la filosofía o la sociología, Bourdieu sostiene que un problema es legítimo, cuando los filósofos y/o sociólogos lo reconocen como tal y que por la autoridad que se les confiere tienen la posibilidad de reconocerlo como problema legítimo del campo.
...
\begin{figure}[ht] % h = here (aquí), puede combinarse con t (top), b (bottom), p (página flotante)
	\centering
	\includegraphics[width=1\textwidth]{media/grafico1.png}
	\caption{Gráfico 1: Representación gráfica de los momentos de la prensa según la taxonomía de Jürgen Habermas (1994)}
	\label{fig:graf2}
\end{figure}
...
Durante el período establecido para la investigación, el campo periodístico mayoritario se percibió agredido por el gobierno. Probablemente la frase: \enquote{¿Qué te pasa \emph{Clarín}? ¿Estás nervioso?},~que expresó Néstor Kirchner unos días antes de las elecciones legislativas del año 2009, reveló la intención del gobierno de confrontar con el grupo de medios más importante del país. Si bien el enfrentamiento contra este medio ya existía desde el año anterior, cuando ambos rompieron relaciones luego de que el gobierno de Cristina Kirchner presentara la resolución 125 \rdm{que pretendía aumentar los impuestos a la actividad agropecuaria} este conflicto no había sido verbalizado tan crudamente.
...
\end{quote}
Unos meses después, Julio Blanck, director editorial de la sección política de \emph{Clarín}, en una entrevista realizada para \emph{laizquierdadiario.com}\footnote{\url{https://www.laizquierdadiario.com/Julio-Blanck-En-Clarin-hicimos-un-periodismo-de-guerra} Domingo 17 de julio de 2016~}, ante la pregunta del periodista Fernando Rosso, expresa:

\begin{quote}
	Tengo la obligación de hacer una pregunta sobre~Clarín. Martín Sivak, que escribió el libro \emph{Clarín, la era Magnetto}, dice que \enquote{por primera vez durante los años kirchneristas \emph{Clarín} cambió su forma de hacer política e hizo un periodismo de guerra}. Escribió en 2014 que más allá de cómo termine el kirchnerismo, iba a ser difícil que \emph{Clarín} vuelva a tener la gravitación que tuvo en la sociedad argentina. Si es así, ¿cómo es el Clarín~de posguerra, cómo es el \emph{Clarín} poskirchnerista o cuál es tu lectura?
\end{quote}

Responde Julio Blanck:

\begin{quote}
	A ver: ¿hicimos periodismo de guerra? Sí. Eso es mal periodismo. Fuimos buenos haciendo guerra, estamos vivos, llegamos vivos al final, al último día. Periodismo eso no es como yo lo entiendo, no es el que me gusta hacer. Y yo lo hice, no le echo la culpa a nadie, yo lo hice. Eran las circunstancias e hice cosas que en circunstancias normales por ahí no hubiese hecho, en términos de qué posición tomar o de cierta cosa terminante. \textbf{Hubo un momento en que la guerra contra \emph{Clarín} pasó a ser la guerra contra los periodistas} (\ldots).\footnote{El énfasis es propio.}
\end{quote}
...
Es este un magnífico discurso legitimante de la actividad de los medios. Pero no era solo \emph{Clarín} o sus periodistas los que se sentían agredidos o en medio de una guerra. Hacia el fin del período seleccionado, Novaro y Birmajer (2015: 8, 11) sostienen, en \emph{Grandes y pequeñas mentiras que nos contaron}:
...
Sin embargo, el conflicto dio oportunidad de acceder de manera indirecta a alguna información cuantitativa de los ingresos de algunos periodistas. Durante el período, se publicaron biografías de algunos de ellos. Ello hace evidente que, por lo menos tres de ellos, se encuentran en el centro del campo: Jorge Lanata, Víctor Hugo Morales y Horacio Verbitsky. Por supuesto, buena parte de los autores de los libros del período también son integrantes reconocidos del campo, ya que de manera indirecta, ser publicados por editoriales comerciales pone de manifiesto que disponen de audiencias que los reconocen y valoran: María Julia Oliván, Graciela Mochkofsky, Pablo Sirvén, Edi Zunino, Luis Majul, Daniel Muchnik, Eduardo Blaustein, Gabriel Levinas, Darío Villarruel, Jorge Fontevecchia, entre otros. Afirmamos también lo son, los periodistas que firman columnas de opinión de los diarios y revistas y los que ofician de conductores de programas de actualidad.
...
%	\begin{tabular}{l | c | c| c| c| c| c| c| c }
	%		\toprule
	%		& \textbf{Medios masivos y dominantes} & \textbf{Medios alternativos} & \textbf{Firman sus notas} & \textbf{Altos ingresos económicos} & \textbf{Grandes audiencias} & \textbf{Autor  de libros} & \textbf{Presencia en medios AV} & \textbf{Objeto de biografías} \\
	%		\midrule
	...
	%		\bottomrule
	%	\end{tabular}
%	\caption{Condiciones mínimas que reúnen los integrantes del campo de acuerdo a sus posiciones en el polígono de fuerzas}
%\end{table}
...
%	\begin{tabularx}{\textwidth}{
		...
		%		}
	%		\toprule
	%		& \textbf{Medios masivos y dominantes}
	%		& \textbf{Medios alternativos}
	%		& \textbf{Firman sus notas}
	%		& \textbf{Altos ingresos económicos}
	%		& \textbf{Grandes audiencias}
	%		& \textbf{Autor de libros}
	%		& \textbf{Presencia en medios AV}
	%		& \textbf{Objeto de biografías} \\
	%		\midrule
	%		Hegemónicos dominantes & Sí & No & Sí & Sí & Sí & Sí & Sí & Sí \\
	%		\midrule
	%		Hegemónicos alternativos & No & Sí & Sí & Sí/No & Sí/No & Sí & Sí/No & Sí \\
...
{\sf\footnotesize % Abre un grupo con fuente sans serif y tamaño pequeño

	\setlength\tabcolsep{4pt}

	\begin{longtable}{|p{4cm}|p{2.1cm}|c|p{2.9cm}|}
		\caption{Universo de los libros considerados} \\
		\hline
		\textbf{Título y año de edición} & \textbf{Editorial} & \textbf{Nº} & \textbf{Autor(es)} \\
		\hline
		\endfirsthead
		...
		\hline \multicolumn{4}{|r|}{{Continúa en la próxima página}} \\
		\hline
		\endfoot
		...
		\hline
		Diario de guerra. \emph{Clarín}, el gran engaño argentino & Gárgola & 1 & Claudio Díaz \\
		\hline
		...
		Perón y los medios de comunicación & Sudamericana / Penguin Random House & 5 & Pablo Sirvén \\
		K Letra bárbara & Sudamericana / Penguin Random House & 6 & Orlando Barone \\
		El kirchnerismo póstumo & Ediciones B & 7 & Jorge Asís \\
		Patria o medios & Sudamericana / Penguin Random House & 8 & Edi Zunino \\
		...
		\hline
		Nuevos desafíos del periodismo & Ariel / Paidós / Planeta-ADEPA & 19 & Daniel Dessein y Gastón Roitberg (Compiladores) \\
		Periodistas en el barro & Sudamericana / Penguin Random House & 20 & Edi Zunino \\
		Tiempos turbulentos & Ariel / Paidós / Planeta-ADEPA & 21 & Carlos Jornet y Daniel Dessein \\
		Télam, el hecho maldito del periodismo argentino & Ediciones TXT & 22 & Ariel Bargach y Mariano Suárez \\
		(In)justicia mediática & Sudamericana / Penguin Random House & 23 & Darío Villarruel \\
		Audiencia con el diablo & Aguilar & 24 & Víctor Hugo Morales \\
		Las locuras del Rey Jorge & Ediciones B & 25 & Eduardo Blaustein \\
		Guerras mediáticas & Sudamericana / Penguin Random House & 26 & Fernando Ruiz \\
		\hline

		\multicolumn{4}{|c|}{\textbf{2015}} \\
		\hline
		Quiénes fuimos en la era k & Planeta & 27 & Jorge Fontevecchia \\
		El Perro & Ediciones B & 28 & Hernán López Echagüe \\
		La inconclusa ley de medios: la historia menos contada & Continente & 29 & Néstor Piccone \\
		Grandes y pequeñas mentiras que nos contaron & Planeta & 30 & Marcos Novaro y Marcelo Birmajer \\
		Doble agente. La biografía inesperada de Horacio Verbitsky & Sudamericana / Penguin Random House & 31 & Gabriel Levinas \\
		...
		Diez ironías sobre la libertad de expresión & CTP & 35 & Autores Varios \\
		Clarín, la era Magnetto & Planeta & 36 & Martín Ernesto Sivak \\
		Periodistas deportivos & Ediciones al arco & 37 & Walter Vargas \\
	\end{longtable}
}
...
Por el contrario a partir del año 2013 y hasta el 2015, es posible observar lo que consideramos el inicio de la ruptura del campo a partir de la disputa abierta entre periodistas. De los 37 libros detectados, 27 lo son en este breve período. Utilizaremos para definir este período, el concepto del periodista de \emph{Clarín}, Julio Blanck, periodismo de guerra.
...
\begin{quote}
	El 10 de noviembre de 1976, después de haber arrancado las acciones a Lidia Papeleo de Graiver, los directivos de \emph{La Razón}, \emph{La Nación} y \emph{Clarín} dieron una \enquote{conferencia de prensa} en la sede de la Asociación de Entidades Periodísticas Argentinas ({\sc{adepa}}), \textbf{esa nefasta asociación de lobby que sobrevive para vergüenza de la libertad de expresión}.\footnote{El énfasis es propio.}
\end{quote}
...
\begin{quote}
	Nadie podría acusar a Verbitsky de opositor. Verdadero titán del periodismo independiente durante los 90 y entendido en guerrillas setentistas, el \emph{Perro} pasó a ser un adalid intelectual del autodefinido \enquote{kirchnerismo racional} (Zunino, 2011: 10).
\end{quote}
...
Uno de los aspectos relevantes del libro, a los efectos de desentrañar su concepción del periodismo frente a la libertad de expresión, es el abordaje y descripción minuciosa del conflicto que produjo la crisis terminal de la Asociación civil \textsc{periodistas}. Si bien estos hechos ocurrieron fuera del período considerado, al ser reanalizado en el contexto del conflicto del campo periodístico ilumina de alguna manera sus orígenes.
...
Las renuncias a la organización \textsc{periodistas} se desencadenaron en dominó.
...
\begin{quote}
	El 29 de marzo, día en que Videla juraba como presidente, el diario de Héctor hizo una enternecedora descripción del jefe del Ejército, que anunció desde la tapa. \enquote{Exclusivo: la infancia del Teniente General Videla}. El reportaje incluía, en la doble central, el testimonio de la maestra de cuarto grado del nuevo presidente. La maestra, fotografiada leyendo \emph{La Tarde}, decía, entre otras cosas: \enquote{Yo les decía a mis alumnos, \enquote{si Sarmiento, siendo de origen tan humilde, llegó a presidente, por qué no puede llegar a serlo uno de ustedes}. Se me dio con Jorge (Videla) y le aseguro que me alegro} (Levinas 2013: 43).
\end{quote}
...
Más adelante Muchnik retoma la historia de \textsc{periodistas} y el conflicto suscitado entre \emph{Página/12} y el periodista Julio Nudler. A partir del conflicto fija su posición. Esta, como vimos, se alineaba con la idea de que es el editor de un diario el que decide qué y cómo se publica
...
Es decir, la situación no era tan grave como los sectores dominantes del campo periodístico pretendían presentarla. En la actualidad, en el mismo ranking del año 2019, la Argentina retrocedió al puesto 57 y a fin de mantener las comparaciones, Estados Unidos subió al puesto 48.
...
\begin{quote}
	Verbitsky dejó de ser uno de los mejores periodistas argentinos, incluso para mí, y se convirtió en el jefe de inteligencia informal del kirchnerismo ---sacudió Alfredo Leuco desde \emph{Radio Continental} el primer día de agosto de 2010, mientras releía sin parar los ácidos comentarios de \emph{El Perro} en \emph{Página/12} sobre su resonante entredicho con Héctor Timerman, ex periodista devenido ministro de Relaciones Exteriores y flamante figurón de la red social Twitter.
\end{quote}
...
\begin{quote}
	Luego, con la salida de Carlos Menem del poder retomó ciertos rasgos de independencia informativa, sobre todo durante el Gobierno de Fernando de la Rúa (Bargach y Suárez, 2014: 35)\footnote{La cita se refiere a {\sc{telam}}.}.
\end{quote}
...
En este intento de colocar en el contexto histórico la propia historia de \textsc{telam}, los autores recuerdan el proceso que devino en la Comisión MacBride:
...
Más adelante, Ruiz Guiñazú (2014: 19) busca legitimar su posición con una palabra autorizada dentro del periodismo internacional: Ignacio Ramonet. La autora utiliza una entrevista realizada por Jorge Fontevecchia en septiembre del año 2011.\footnote{\url{http://www.attacmadrid.org/?p=5496}}
...
Un balance editorial del año 2014, permite concluir, por un lado, que da comienzo al inicio de la resistencia de algunos periodistas que observan el proceso de confrontación. Por otro, las dos producciones de \textsc{adepa}, parecen marcar cuál será la agenda metaperiodística de los grandes medios para el año que se avecina.
...
El medio de comunicación valida de manera colectiva a los periodistas que lo integran, pero ese colectivo ha comenzado a transformarse aceleradamente. El cambio sustancial en las relaciones de propiedad de los medios de comunicación y la pérdida de rentabilidad, basada en la publicidad explícita, han dado por resultado la preeminencia de la empresa editorial por sobre el colectivo de periodistas. Cuando los periodistas ven disminuir las fuentes de trabajo, las empresas periodísticas, agencias y medios de comunicación se tornan subordinantes, si se pretende mantener la condición de periodistas.\footnote{Según el informe elaborado por el Observatorio y alerta laboral de periodistas de {\sc{fopea}} 2017--2018, se han perdido 1.791 puestos de trabajo en la prensa argentina entre 2017 y 2018. \url{https://www.fopea.org/informe-observatorio-y-alerta-laboral-de-periodistas-de-fopea-2017-2018/}}
...
\begin{quote}
	El periódico califica al Gobierno como democrático o no según asuma, frente a él o al conjunto de la prensa, una política comunicativa que favorezca o perjudique a los intereses de la gran industria periodística. La libertad de prensa \rdm{entendida como epifanía de la libertad de empresa} deviene así, desde la perspectiva del periódico, la medida de todas las cosas.
\end{quote}
...
\chapter[\hspace{1.5pc}Post scriptum]{Post scriptum}
