...
\usepackage{caption}
\usepackage{hyperref}
\usepackage{array}      % para >{\ragged...}p{...}
\usepackage{multirow}   % para \multirow (encabezado)
\usepackage{booktabs}   % <-- define \toprule, \midrule, \cmidrule, \bottomrule
\usepackage{soul}
...
\begin{longtable}{@{}
		>{\raggedright\arraybackslash}p{0.206\linewidth}  % Medio
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2010
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2011
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2012
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2013
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2014
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2015
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2016
		>{\raggedleft\arraybackslash}p{0.088\linewidth}   % 2017
		>{\raggedleft\arraybackslash}p{0.088\linewidth}@{}} % 2018
	\toprule
	\multirow{2}{*}{\textbf{Medio}} &
	\multicolumn{9}{c}{\textbf{Inversión publicitaria por medio (\%)}} \\*[-0.3em]
	\cmidrule(l){2-10}
	& \textbf{2010} & \textbf{2011} & \textbf{2012} & \textbf{2013} &
	\textbf{2014} & \textbf{2015} & \textbf{2016} & \textbf{2017} & \textbf{2018} \\
	\midrule
	\endhead
	%------------------------------------------------------------------
	...
	\textbf{Radios (AMBA e interior)}       & \textbf{3,2}  & \textbf{3,2}  & \textbf{3,7}  & \textbf{4,0}  & \textbf{4,6}  & \textbf{5}    & \textbf{8}   & \textbf{8}  & \textbf{8}  \\
	\textbf{Diarios (AMBA e interior)}      & \textbf{34}   & \textbf{35}   & \textbf{34}   & \textbf{31}   & \textbf{25}   & \textbf{22}   & \textbf{21}  & \textbf{16} & \textbf{15} \\
